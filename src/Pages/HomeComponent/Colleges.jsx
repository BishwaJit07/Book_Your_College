...
const Colleges = () => {
    ...
    college && college.college_name && college.college_name.toLowerCase().includes(searchTerm.toLowerCase())
  );
    return (
        <>
...
<div key={college._id} className="card  glass shadow-xl bg-gradient-to-br from-blue-400 to-blue-700 rounded-lg p-4 w-96">
